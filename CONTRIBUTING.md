...
repository](https://github.com/IBM/kafka-streaming).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/kafka-streaming/issues). Before embarking on
...
issue](https://github.com/IBM/kafka-streaming/issues) before sending a pull
...
Please feel free to connect with us: [here](https://github.com/IBM/kafka-streaming/issues)
